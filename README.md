- Tiến hành phân toán database sang các server ứng với các chi nhánh đã tạo. Trong đó bảng Category, Type và Customer là nhân bảng, còn lại các bảng phân mảnh ngang theo mã chi nhánh.
